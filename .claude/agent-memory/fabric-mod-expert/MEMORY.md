...
- [Phase 3 dirty-events + transfers](project_phase3_transfers.md) — gate hopper pushItemsTick by dormancy; setChanged emits dirty; runtime position-keyed TransferNetwork (Phase 4 replaces it)
